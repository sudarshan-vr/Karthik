...
Thank you for contacting KITE Tuition Center. We have received your message and will get back to you as soon as possible.
...
Best regards,
KITE Tuition Center Team`
    };

    try {
      // Send to admin
      const response = await fetch('https://formsubmit.co/ajax/admin@drkiteacademy.com', {
        method: 'POST',
        headers: { 
