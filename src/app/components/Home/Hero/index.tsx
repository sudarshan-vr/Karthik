      ...
      <div className='relative px-6 lg:px-8'>
        <div className='container'>
          <div className='flex flex-col gap-4 text-center'>
            ...
            KITE | Karthik Intellect Tuition for Excellence
            </h1>
            <p className='text-lg leading-8 text-black'>
              KNOWLEDGE HAS NO LIMITS, At KITE Tutorials, we believe every child is capable of flying high.
            </p>
              ...
              <div className='flex items-center justify-center gap-8'>
                ...
                <div>
                  <div className='flex justify-center sm:justify-start'>
                    <h3 className='text-2xl font-semibold mr-2'>4.7</h3>
                    <Image
                  ...
                  <div>
                    <h3 className='text-sm'>Positive Reviews.</h3>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='mx-auto max-w-4xl mt-12 p-6 lg:max-w-5xl lg:px-8 bg-white rounded-lg boxshadow'>
            <div className='flex flex-col md:flex-row gap-4 items-center'>
              ...
              <div className='w-full md:w-1/5 mt-4 md:mt-0'>
                <Link href={'/#courses-section'} className='block w-full'>
